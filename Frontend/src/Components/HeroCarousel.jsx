  ...
  return (
    ...
    >
      ...
      <SwiperSlide>
        <section 
          className="
          relative h-[80vh] w-full flex items-center justify-center bg-Hero1Mobile md:bg-HeroImgSmall1 bg-cover">
   ...
   <div className="flex flex-col items-start text-start w-full lg:w-[60%]">
     ...
     {/* Description */}
     <p className="mt-5 max-w-2xl text-base sm:text-2xl text-white w-[80%]">
     ...
     <div className="mt-8 flex flex-col sm:flex-row gap-4">
      ...
      {/* Slide 2 */}
      <SwiperSlide>
        <section className="relative h-[80vh] w-full flex items-center bg-cover justify-center bg-Hero2Mobile md:bg-HeroImgSmall2">
   ...
   <div className="flex flex-col items-start text-start w-full lg:w-[60%]">
     ...
     <div className="mt-8 flex flex-col sm:flex-row gap-4">
      ...
      {/* Slide 3 */}
      <SwiperSlide>
        <section className="relative h-[80vh] w-full flex items-center bg-cover justify-center bg-Hero3Mobile md:bg-HeroImgSmall4">
   ...
   <div className="flex flex-col items-start text-start w-full lg:w-[55%]">
     ...
     <div className="mt-8 flex flex-col sm:flex-row gap-4">
      ...
      {/* Slide 4 */}
      <SwiperSlide>
        <section className="relative h-[80vh] w-full flex items-center bg-cover justify-center bg-Hero4Mobile md:bg-HeroImgSmall3">
